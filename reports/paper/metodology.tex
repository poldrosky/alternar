...
obtuvieron aplicando el modelo obtenido en el análisis de regresión a datos agrupados en cada punto por mes, año y uno general entre el año 2000 a 2014; y la 
 ...
 En la figura~\ref{fig:MapasBiomasa}, se muestra los mapas obtenidos por mes, año y general entre el año 2000 a 2014. 
 
 \begin{figure}
  \centering
  \subfigure[Por meses]{\label{Por meses} \includegraphics[width= 8cm]{meses.pdf}}
  \vfill
  \subfigure[Por años]{\label{Por años}\includegraphics[width= 8cm]{anios.pdf}}
  \vfill
  \subfigure[General de 2000-2014]{\label{General de 2000-2014}\includegraphics[width= 8cm]{total.pdf}}
  \caption{Mapas de Biomasa}
  \label{fig:MapasBiomasa}
\end{figure}